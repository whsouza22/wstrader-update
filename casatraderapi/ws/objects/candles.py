"""Module for CasaTrader Candles websocket object."""

from casatraderapi.ws.objects.base import Base


class Candle(object):
    """Class for CasaTrader candle."""
...
class Candles(Base):
    """Class for CasaTrader Candles websocket object."""
    ...
    def first_candle(self):
        ...
        :returns: The instance of :class:`Candle
            <casatraderapi.ws.objects.candles.Candle>`.
        """
