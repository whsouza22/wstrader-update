# python
from casatraderapi.api import CasaTraderAPI
import casatraderapi.constants as OP_code
import casatraderapi.country_id as Country
import threading
import time
import json
import logging
...
from casatraderapi.expiration import get_expiration_time, get_remaning_time
from casatraderapi.version_control import api_version
...
class Casa_Trader:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = CasaTraderAPI(
            "ws.trade.casatrade.com", self.email, self.password)
        check = None
...
##############################################################################################
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/casatraderapi/issues/196 | https://github.com/kkagill )
...
# __________________for Digital___________________
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/casatraderapi/issues/65#issuecomment-513998357
