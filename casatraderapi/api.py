...
from casatraderapi.http.loginv2 import Loginv2
from casatraderapi.http.logout import Logout
from casatraderapi.http.login2fa import Login2FA
from casatraderapi.http.send_sms import SMS_Sender
from casatraderapi.http.verify import Verify
from casatraderapi.http.getprofile import Getprofile
from casatraderapi.http.auth import Auth
from casatraderapi.http.token import Token
from casatraderapi.http.appinit import Appinit
from casatraderapi.http.billing import Billing
from casatraderapi.http.buyback import Buyback
from casatraderapi.http.changebalance import Changebalance
from casatraderapi.http.events import Events
from casatraderapi.ws.client import WebsocketClient
from casatraderapi.ws.chanels.get_balances import *

from casatraderapi.ws.chanels.ssid import Ssid
from casatraderapi.ws.chanels.subscribe import *
from casatraderapi.ws.chanels.unsubscribe import *
from casatraderapi.ws.chanels.setactives import SetActives
from casatraderapi.ws.chanels.candles import GetCandles
from casatraderapi.ws.chanels.buyv2 import Buyv2
from casatraderapi.ws.chanels.buyv3 import *
from casatraderapi.ws.chanels.user import *
from casatraderapi.ws.chanels.api_game_betinfo import Game_betinfo
from casatraderapi.ws.chanels.instruments import Get_instruments
from casatraderapi.ws.chanels.get_financial_information import GetFinancialInformation
from casatraderapi.ws.chanels.strike_list import Strike_list
from casatraderapi.ws.chanels.leaderboard import Leader_Board

from casatraderapi.ws.chanels.traders_mood import Traders_mood_subscribe
from casatraderapi.ws.chanels.traders_mood import Traders_mood_unsubscribe
from casatraderapi.ws.chanels.technical_indicators import Technical_indicators
from casatraderapi.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from casatraderapi.ws.chanels.get_order import Get_order
from casatraderapi.ws.chanels.get_deferred_orders import GetDeferredOrders
from casatraderapi.ws.chanels.get_positions import *

from casatraderapi.ws.chanels.get_available_leverages import Get_available_leverages
from casatraderapi.ws.chanels.cancel_order import Cancel_order
from casatraderapi.ws.chanels.close_position import Close_position
from casatraderapi.ws.chanels.get_overnight_fee import Get_overnight_fee
from casatraderapi.ws.chanels.heartbeat import Heartbeat


from casatraderapi.ws.chanels.digital_option import *
from casatraderapi.ws.chanels.api_game_getoptions import *
from casatraderapi.ws.chanels.sell_option import Sell_Option
from casatraderapi.ws.chanels.sell_digital_option import Sell_Digital_Option
from casatraderapi.ws.chanels.change_tpsl import Change_Tpsl
from casatraderapi.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from casatraderapi.ws.objects.timesync import TimeSync
from casatraderapi.ws.objects.profile import Profile
from casatraderapi.ws.objects.candles import Candles
from casatraderapi.ws.objects.listinfodata import ListInfoData
from casatraderapi.ws.objects.betinfo import Game_betinfo_data
import casatraderapi.global_value as global_value
...
class CasaTraderAPI(object):  # pylint: disable=too-many-instance-attributes
    """Class for communication with CasaTrader API."""
    ...
    def __init__(self, host, username, password, proxies=None):
        """
        :param str host: The hostname or ip address of a CasaTrader server.
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <casatraderapi.http.resource.Resource>`.

        :returns: The full url to CasaTrader http resource.
        """
    ...
    def send_http_request(self, resource, method, data=None, params=None, headers=None):  # pylint: disable=too-many-arguments
        """Send http request to CasaTrader server.
    ...
    def send_websocket_request(self, name, msg, request_id="", no_force_send=True):
        """Send websocket request to CasaTrader server.
    ...
    @property
    def logout(self):
        """Property for get CasaTrader http login resource.

        :returns: The instance of :class:`Login
            <casatraderapi.http.login.Login>`.
        """
        return Logout(self)
    ...
    @property
    def login_2fa(self):
        """Property for get CasaTrader http login 2FA resource.

        :returns: The instance of :class:`Login2FA
            <casatraderapi.http.login2fa.Login2FA>`.
        """
        return Login2FA(self)

    @property
    def send_sms_code(self):
        """Property for get CasaTrader http send sms code resource.

        :returns: The instance of :class:`SMS_Sender
            <casatraderapi.http.send_sms.SMS_Sender>`.
        """
        return SMS_Sender(self)

    @property
    def verify_2fa(self):
        """Property for get CasaTrader http verify 2fa resource.

        :returns: The instance of :class:`Verify
            <casatraderapi.http.verify.Verify>`.
        """
        return Verify(self)

    @property
    def loginv2(self):
        """Property for get CasaTrader http loginv2 resource.

        :returns: The instance of :class:`Loginv2
            <casatraderapi.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)

    @property
    def auth(self):
        """Property for get CasaTrader http auth resource.

        :returns: The instance of :class:`Auth
            <casatraderapi.http.auth.Auth>`.
        """
        return Auth(self)

    @property
    def appinit(self):
        """Property for get CasaTrader http appinit resource.

        :returns: The instance of :class:`Appinit
            <casatraderapi.http.appinit.Appinit>`.
        """
        return Appinit(self)

    @property
    def token(self):
        """Property for get CasaTrader http token resource.

        :returns: The instance of :class:`Token
            <casatraderapi.http.auth.Token>`.
        """
        return Token(self)

    # @property
    # def profile(self):
    #     """Property for get CasaTrader http profile resource.

    #     :returns: The instance of :class:`Profile
    #         <casatraderapi.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        """Property for get CasaTrader http changebalance resource.

        :returns: The instance of :class:`Changebalance
            <casatraderapi.http.changebalance.Changebalance>`.
        """
    ...
    @property
    def billing(self):
        """Property for get CasaTrader http billing resource.

        :returns: The instance of :class:`Billing
            <casatraderapi.http.billing.Billing>`.
        """
        return Billing(self)

    @property
    def buyback(self):
        """Property for get CasaTrader http buyback resource.

        :returns: The instance of :class:`Buyback
            <casatraderapi.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    @property
    def getprofile(self):
        """Property for get CasaTrader http getprofile resource.

        :returns: The instance of :class:`Login
            <casatraderapi.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    @property
    def ssid(self):
        """Property for get CasaTrader websocket ssid chanel.

        :returns: The instance of :class:`Ssid
            <casatraderapi.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        "candle-generated"
        """Property for get CasaTrader websocket subscribe chanel.

        :returns: The instance of :class:`Subscribe
            <casatraderapi.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        """Property for get CasaTrader websocket unsubscribe chanel.

        :returns: The instance of :class:`Unsubscribe
            <casatraderapi.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    @property
    def setactives(self):
        """Property for get CasaTrader websocket setactives chanel.

        :returns: The instance of :class:`SetActives
            <casatraderapi.ws.chanels.setactives.SetActives>`.
        """
    ...
    @property
    def getcandles(self):
        """Property for get CasaTrader websocket candles chanel.

        :returns: The instance of :class:`GetCandles
            <casatraderapi.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    @property
    def buy(self):
        """Property for get CasaTrader websocket buyv2 request.

        :returns: The instance of :class:`Buyv2
            <casatraderapi.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
...
# -------------------------------------------------------
    ...
    def connect(self):
        ...
        global_value.ssl_Mutual_exclusion_write = False
        """Method for connection to CasaTrader API."""
        try:
            self.close()
        except:
            pass
        ...
        if global_value.SSID != None:
            ...
            if check_ssid == False:
                # ssdi time out need reget,if sent error ssid,the weksocket will close by CasaTrader server
