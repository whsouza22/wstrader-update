"""Module for CasaTrader changebalance resource."""

from casatraderapi.http.resource import Resource
from casatraderapi.http.profile import Profile


class Changebalance(Resource):
    """Class for CasaTrader changebalance resource."""
    # pylint: disable=too-few-public-methods

    url = "/".join((Profile.url, "changebalance"))

    def _post(self, data=None, headers=None):
        """Send get request for CasaTrader API changebalance http resource.
    ...
    def __call__(self,balance_id):
        """Method to get CasaTrader API changebalance http request.
