"""Module for CasaTrader http verify resource."""
...
class Verify(Resource):
    """Class for CasaTrader verify resource."""
    # pylint: disable=too-few-public-methods

    url = ""

    def _post(self, data=None, headers=None):
        """Send get request for CasaTrader API verify http resource.
    ...
    def __call__(self, sms_received, token_sms):
        """Method to get CasaTrader API verify http request.

        :param str sms_received: The sms received of a CasaTrader server 2FA.
        :param str token_sms: The token of a CasaTrader server 2FA.
