...
; ================================
Name "WS Trader AI"
OutFile "WsTrader_Setup_5.3.exe"
...
VIAddVersionKey /LANG=${LANG_PORTUGUESEBR} "FileVersion" "5.3"
VIAddVersionKey /LANG=${LANG_PORTUGUESEBR} "ProductVersion" "5.3"
...
Section "WS Trader AI" SecMain
    ...
    WriteRegStr HKLM "Software\WsTrader" "Version" "5.3"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\WsTrader" "DisplayVersion" "5.3"
